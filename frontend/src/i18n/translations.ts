...
export const T: Dict = {
  ...
  "nav.about": { fr: "Assistant guidé", ar: "المساعد الموجّه", en: "Guided Assistant" },
  ...
  "nav.documents": { fr: "Documents", ar: "الوثائق", en: "Documents" },
  "nav.users": { fr: "Utilisateurs", ar: "المستخدمون", en: "Users" },
